...
type Player struct {
	...
	Stats        *Stats `gorm:"foreignKey:PlayerID;constraint:OnDelete:CASCADE" json:"stats,omitempty"`
}
...
// Stats holds gameplay-derived state, separated from identity so that
...
func (Stats) TableName() string { return "player_stats" }
